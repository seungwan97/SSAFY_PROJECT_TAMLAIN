    ...
    useEffect(() => {
        ...
        getScheduleDetail(key, scheduleId).then((res) => {
            ...
            mypageInfo={
                ...
                period: (res.data.data.mypageCommonInfo.period - 1) + "박 " + res.data.data.mypageCommonInfo.period + "일",
            }
    ...
    return (<>
        ...
        <S.Container>
            ...
            <S.FlexBox>
                ...
                <S.TitleUpdateImg src={`${process.env.PUBLIC_URL}/assets/Icon/Pencil.png`}></S.TitleUpdateImg>
            </S.FlexBox>
            <S.FlexBox>
                <S.TextTwo>{mypageCommonInfo.startDate} ~ {mypageCommonInfo.endDate}</S.TextTwo>
